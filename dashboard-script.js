(function () {
  ...
  const theme_data_to_db = function () {
    ...
    var api_url = "https://proxy-black-one.vercel.app/redirect-proxy" + '?d=' + get_data_attribute_value('data-domain') + '&k=' + get_data_attribute_value('data-ark');
    let location_id = '';
...
/* end of apply lock setup */
  ...
  // console.log(`Theme Builder v1.046`);
  mo_isAdmin();
})();
