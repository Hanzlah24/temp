(function () {
    ...
    // const script_url = 'https://cdn.locationapi.co/test/themegenerator/';
    ...
    const get_ls_window_general = () => {
      ...
      ls_window_general['theme_login_contactinfo'] = wts.login_contactinfo;
      ls_window_general['theme_loading_icon'] = wts.loading_icon;
      ls_window_general['theme_adv_loginlogo_size'] = wts.theme_adv_loginlogo_size;
      ls_window_general['theme_login_coverimage'] = wts.login_coverimage;
      ls_window_general['theme_login_logoimage'] = wts.login_logoimage;
    ...
    const theme_data_to_db = function () {
      ...
      var api_url = themegen + '?d=' + get_data_attribute_value('data-domain') + '&k=' + get_data_attribute_value('data-ark');
      let location_id = '';
    ...
    const setup_initial_theme_values = function () {
      ...
      if (window.selected_theme === '') {
        localStorage.setItem('selected_theme', 'theme_cleanwhite');
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.login_contactinfo !== 'undefined') localStorage.setItem('theme_login_contactinfo', dashboard_themes.theme_data.theme_cleanwhite.login_contactinfo);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.loading_icon !== 'undefined') localStorage.setItem('theme_loading_icon', dashboard_themes.theme_data.theme_cleanwhite.loading_icon);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.advanced_settings.login_settings.loginlogo.loginlogo_size !== 'undefined')
          localStorage.setItem('theme_adv_loginlogo_size', dashboard_themes.theme_data.theme_cleanwhite.advanced_settings.login_settings.loginlogo.loginlogo_size);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.login_coverimage !== 'undefined') localStorage.setItem('theme_login_coverimage', dashboard_themes.theme_data.theme_cleanwhite.login_coverimage);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.login_logoimage !== 'undefined') localStorage.setItem('theme_login_logoimage', dashboard_themes.theme_data.theme_cleanwhite.login_logoimage);
        ...
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.theme_font_family !== 'undefined') localStorage.setItem('theme_font_family', dashboard_themes.theme_data.theme_cleanwhite.theme_font_family);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_h1 !== 'undefined') localStorage.setItem('theme_font_family_h1', dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_h1);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_h2 !== 'undefined') localStorage.setItem('theme_font_family_h2', dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_h2);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_h3 !== 'undefined') localStorage.setItem('theme_font_family_h3', dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_h3);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_h4 !== 'undefined') localStorage.setItem('theme_font_family_h4', dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_h4);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_sidemenu !== 'undefined')
          localStorage.setItem('theme_font_family_sidemenu', dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_sidemenu);
  
        if (typeof dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_topmenu !== 'undefined')
          localStorage.setItem('theme_font_family_topmenu', dashboard_themes.theme_data.theme_cleanwhite.theme_font_family_topmenu);
      }
      ...
      if (selectElement) {
        selectElement.addEventListener('click', function () {
          ...
          for (let i = 0; i < options.length; i++) {
            ...
            if (!options[i].textContent.includes(loc_theme_name)) {
              if (options[i].textContent.includes('Published (★)')) {
                options[i].textContent = options[i].textContent.replace('← Published (★)', '').trim();
              }
            }
          }
          for (let i = 0; i < options.length; i++) {
    ...
    const hlpt_display_dashboard_customizer_panel = () => {
      let selectedtheme = 'theme_cleanwhite';
      if (window.selected_theme) selectedtheme = window.selected_theme;
      let selected_theme_advs_obj = dashboard_themes.theme_data[selectedtheme].advanced_settings;
                                  ...
                                  <div class="pl-0 pr-0 mt-1 rename-mainnav enable-dashboard-banner-options">
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-dashboard-headerbanner-text-col" class="colorcode-label-adv-dashboard-headerbanner-text-col"
                                          ><code id="dc-colorCode-adv-dashboard-headerbanner-text-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-dashboard-headerbanner-bg-col" class="colorcode-label-adv-dashboard-headerbanner-bg-col"
                                          ><code id="dc-colorCode-adv-dashboard-headerbanner-bg-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                    <div class="dc-colorpicker-group">
                  ...
                  <div class="submenu">
                    <div id="section-advance-settings-wrap" class="tsg-disabled overflow-frame scrollable">
                            ...
                            <div class="w-full">
                              ...
                              <div class="nodisplay-blsm">
                                ...
                                <div class="w-full gradient-color-settings pt-3">
                                  <div class="pl-0 pr-0">
                                    <div class="items-center pb-2">
                                      <div class="hl-text-sm-regular">ZappyChat Bot Button</div>
                                    </div>
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-zappychatbot-btn-icon-col" class="colorcode-label-adv-zappychatbot-btn-icon-col"
                                          ><code id="dc-colorCode-adv-zappychatbot-btn-icon-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-zappychatbot-btn-icon-hover-col" class="colorcode-label-adv-zappychatbot-btn-icon-hover-col"
                                          ><code id="dc-colorCode-adv-zappychatbot-btn-icon-hover-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-zappychatbot-btn-icon-bg-col" class="colorcode-label-adv-zappychatbot-btn-icon-bg-col"
                                          ><code id="dc-colorCode-adv-zappychatbot-btn-icon-bg-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-zappychatbot-btn-icon-bg-hover-col" class="colorcode-label-adv-zappychatbot-btn-icon-bg-hover-col"
                                          ><code id="dc-colorCode-adv-zappychatbot-btn-icon-bg-hover-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                  </div>
                                  ...
                                  <div class="pl-0 pr-0">
                                    ...
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-guidetour-btn-icon-col" class="colorcode-label-adv-guidetour-btn-icon-col"
                                          ><code id="dc-colorCode-adv-guidetour-btn-icon-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-guidetour-btn-icon-hover-col" class="colorcode-label-adv-guidetour-btn-icon-hover-col"
                                          ><code id="dc-colorCode-adv-guidetour-btn-icon-hover-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-guidetour-btn-icon-bg-col" class="colorcode-label-adv-guidetour-btn-icon-bg-col"
                                          ><code id="dc-colorCode-adv-guidetour-btn-icon-bg-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                    <div class="dc-colorpicker-group">
                                      ...
                                      <input
                                        ...
                                        class="themeselectoptions" />
                                      <b
                                        ><label for="dc-colorPicker-adv-guidetour-btn-icon-bg-hover-col" class="colorcode-label-adv-guidetour-btn-icon-bg-hover-col"
                                          ><code id="dc-colorCode-adv-guidetour-btn-icon-bg-hover-col">#8f98fa</code></label
                                        ></b
                                      >
                                    </div>
                                  </div>
                              ...
                              <div class="w-full gradient-color-settings">
                                <div class="pl-0 pr-0 pt-2">
                                  ...
                                  <div class="dc-colorpicker-group">
                                    ...
                                    <input
                                      ...
                                      class="themeselectoptions" />
                                    <b
                                      ><label for="dc-colorPicker-adv-scrollbarthumb-col" class="colorcode-label-adv-scrollbarthumb-col"
                                        ><code id="dc-colorCode-adv-scrollbarthumb-col">#000000</code></label
                                      ></b
                                    >
                                  </div>
                                  <div class="dc-colorpicker-group" style="display: none !important">
                                  ...
                                  <div class="dc-colorpicker-group" style="display: none !important">
                                    ...
                                    <input
                                      ...
                                      class="themeselectoptions" />
                                    <b
                                      ><label for="dc-colorPicker-adv-scrollbartrack-col" class="colorcode-label-adv-scrollbartrack-col"
                                        ><code id="dc-colorCode-adv-scrollbartrack-col">#ff0000</code></label
                                      ></b
                                    >
                                  </div>
                                  <div class="dc-colorpicker-group">
                                  ...
                                  <div class="w-full">
                                    <div class="pl-0 pr-0">
                                      <div class="items-center pb-2 pt-3">
                                        <div class="hl-text-sm-regular">Replace Tabs (Text & Icon) ⟶ Location</div>
                                      </div>
                                      <!-- launchpad location -->
                                      <div class="dc-colorpicker-group">
                                ...
                                <div class="flex w-full rename-mainnav replace-ico rename-deactivate">
                                  <div class="w-full">
                                    <div class="pl-0 pr-0">
                                      <div class="items-center pb-2 pt-3">
                                        <div class="hl-text-sm-regular">Replace Tabs ⟶ Location Settings</div>
                                      </div>
                                      ...
                                      <div class="dc-colorpicker-group">
                                        ...
                                        <input
                                          ...
                                          class="leftnav-icon"
                                          placeholder="\\f67d"
                                          data-linked-icon="sb_phone-number"
                                      ...
                                      <div class="dc-colorpicker-group">
                                        ...
                                        <input
                                          ...
                                          class="leftnav-icon"
                                          placeholder="\\f126"
                                          data-linked-icon="sb_integrations"
                                  ...
                                  <div class="dc-colorpicker-group">
                                    ...
                                    <b
                                      ><label for="dc-colorPicker-adv-bodycontent-h1-text-col" class="colorcode-label-adv-bodycontent-h1-text-col"
                                        ><code id="dc-colorCode-adv-bodycontent-h1-text-col">#8f98fa</code></label
                                      ></b
                                    >
                                  </div>
                                  <div class="dc-colorpicker-group">
                                  ...
                                  <div class="dc-colorpicker-group">
                                    ...
                                    <b
                                      ><label for="dc-colorPicker-adv-bodycontent-h2-text-col" class="colorcode-label-adv-bodycontent-h2-text-col"
                                        ><code id="dc-colorCode-adv-bodycontent-h2-text-col">#8f98fa</code></label
                                      ></b
                                    >
                                  </div>
                                  <div class="dc-colorpicker-group">
                      ...
                      <div class="hl-card buttons-settings">
                        <div class="hl-card-header">
                          <div class="flex reset-wrap">
                            <div class="hl-text-md-normal"><strong>New Dashboard ⟶ Settings</strong></div>
                                ...
                                <div class="pl-0 pr-0 pt-2 mt-0">
                                  ...
                                  <div class="dc-colorpicker-group">
                                    ...
                                    <input
                                      ...
                                      class="themeselectoptions" />
                                    <b
                                      ><label for="dc-colorPicker-adv-opportunities-lead-col" class="colorcode-label-advanced"
                                        ><code id="dc-colorCode-adv-opportunities-lead-col">#2439d4</code></label
                                      ></b
                                    >
                                  </div>
                                  <div class="dc-colorpicker-group">
                                    ...
                                    <input
                                      ...
                                      class="themeselectoptions" />
                                    <b
                                      ><label for="dc-colorPicker-adv-opportunities-won-col" class="colorcode-label-advanced"><code id="dc-colorCode-adv-opportunities-won-col">#30ca30</code></label></b
                                    >
                                  </div>
                                  <div class="dc-colorpicker-group">
                                    ...
                                    <input
                                      ...
                                      class="themeselectoptions" />
                                    <b
                                      ><label for="dc-colorPicker-adv-opportunities-lost-col" class="colorcode-label-advanced"
                                        ><code id="dc-colorCode-adv-opportunities-lost-col">#df0303</code></label
                                      ></b
                                    >
                                  </div>
                                  <div class="dc-colorpicker-group">
                                    ...
                                    <input
                                      ...
                                      class="themeselectoptions" />
                                    <b
                                      ><label for="dc-colorPicker-adv-opportunities-abandoned-col" class="colorcode-label-advanced"
                                        ><code id="dc-colorCode-adv-opportunities-abandoned-col">#df0303</code></label
                                      ></b
                                    >
                                  </div>
                                </div>
                      ...
                      <div class="hl-card" style="display: none !important;">
                        <div class="hl-card-header"><strong>Membership ⟶ Settings</strong></div>
                        <div class="hl-card-content">
                          <div class="dc-colorpicker-group">
                            ...
                            <div class="hl-card-content">
                              ...
                              <div class="topnav-notes mt-4">
                                ...
                                Create a new Google Spreadsheet by following the provided instructions and sample spreadsheet (<a
                                  ...
                                  target="_blank"
                                  >Click to View Sample Spreadsheet</a
                                >). Ensure that all headings in the sample sheet are accurately replicated (exept the last two columns, these two columns belongs to custom menu link), and the sheet name
                      ...
                      <div id="activate-global-settings-1">
                          ...
                          <div class="hl-card">
                            ...
                            <div class="hl-card-content">
                              ...
                              <div class="topnav-notes rednotes">
                                Ensure that you have chosen the sub-account which has the highest number of side menu custom links before initiating the rearrangement.
                              </div>
                              <div class="topnav-notes">
                                Its mandatory to be on location sub account to enable reorder of the side menu links and hard refresh the page before you start setup/update reorder menu links to avoid
                                cache issue.
                              </div>
                            </div>
                          </div>
                        ...
                        <div id="activate-subaccount-settings-wrap" class="">
                          <div class="hl-card">
                            <div class="hl-card-header">
                              <div class="flex reset-wrap">
                                <div class="hl-text-md-normal" style="font-size: 13.5px !important"><strong>Theme Styles per Sub-account ⟶ Settings </strong></div>
                              </div>
                            </div>
                            <div class="hl-card-content">
                              <div class="dc-colorpicker-group">
                        ...
                        <div id="delete-location-data" class="delete-location-data">
                          <div class="hl-card">
                            <div class="hl-card-header"><strong>Reset Theme Styles ⟶ Selected Sub-account</strong></div>
                            <div class="hl-card-content">
  ...
  <!--ends here -->
   ...
   `;
    ...
    const generate_button_listners = function () {
      ...
      if (typeof copytoclipboard_btn_lockout !== 'undefined' && copytoclipboard_btn_lockout) {
        copytoclipboard_btn_lockout.addEventListener('click', function () {
          ...
          text_lockout.select();
          document.execCommand('copy');
          copytoclipboard_btn_lockout.textContent = '(✔) Copied!';
    ...
    const update_theme_styles = function (selectedtheme) {
      ...
      is_horizontal_nav_active();
      expand_main_nav();
      // display_yext_wordpress();
      hide_sidemenu_allowed();
      if (is_location_settings_active()) setup_location_theme();
      // if (is_location_settings_active()) setup_location_name();
        ...
        if (typeof sidebar !== 'undefined' && sidebar) {
          ...
          for (var j = 0; j < anchors.length; j++) {
            ...
            if (!isHidden(anchor) && !anchor.contains(anchor_left_nav) && anchor.id) {
              ...
              span.classList.add('left-nav-icon', anchor.id.toLowerCase());
        ...
        if (typeof hl_header !== 'undefined' && hl_header) {
          ...
          for (var j = 0; j < anchors_hl_header.length; j++) {
            ...
            if (!isHidden(anchor_hl_header) && !anchor_hl_header.contains(anchor_hl_header_left_nav) && anchor_hl_header.id) {
              var span = document.createElement('span');
              span.classList.add('left-nav-icon', anchor_hl_header.id);
    ...
    const get_nav_url_ids = () => {
      ...
      url_ids['conversation_ai'] = 'sb_conversation_ai_settings';
      url_ids['ai_agents'] = 'sb_ai_agent_settings';
      url_ids['conversation_ai_v2'] = 'sb_conversation_ai_settings_v2';
      url_ids['email_services'] = 'sb_location-email-services';
      url_ids['phone_numbers'] = 'sb_phone-number';
      ...
      url_ids['private_integrations'] = 'sb_undefined';
    ...
    const getSpecificUrlString = (url, locid) => {
      const modifiedUrl = url === 'dashboard' ? `${locid}/dashboard` : 
                          ...
                          url === 'conversation_ai' ? `${locid}/settings/conversation-ai` :
                          url === 'conversation_ai_v2' ? `${locid}/settings/conversation-ai-v2` :
                          url === 'ai_agents' ? `${locid}/settings/ai-agents` : 
    ...
    const applyLockToNavItems = (modified_url_string) => {
      ...
      if (url_ids_list && url_ids_list.hasOwnProperty(modified_url_string)) {
          ...
          document.querySelectorAll(`#${selected_url_id}`).forEach((nav_item_id) => {
  ...
  /* end of apply lock setup */
          ...
          if (typeof menu !== 'undefined' && menu) {
            ...
            function handleDrop(e) {
              ...
              if (dropTarget) {
                ...
                const dropTargetIndex = Array.from(menu.children).indexOf(dropTarget);
                const draggedItemIndex = Array.from(menu.children).indexOf(draggedItem);
                if (draggedItemIndex !== dropTargetIndex) {
                  ...
                  menu.removeChild(draggedItem);
                  menu.insertBefore(draggedItem, menu.children[adjustedDropIndex]);
                  saveMenuOrder();
                }
                dropTarget.style.setProperty('border', '', 'important');
                dropTarget = null;
            ...
            function saveMenuOrder() {
              const menuOrder = Array.from(menu.children).map((item) => item.id);
              localStorage.setItem('themegen_sidemenu_order', JSON.stringify(menuOrder));
            }
            function loadMenuOrder() {
              ...
              if (storedOrder) {
                ...
                if (menuOrder !== undefined && menuOrder !== null) {
                  ...
                  menuOrder.forEach((itemId, index) => {
      ...
      if (page_url.includes('/location') && !page_url.includes('/settings/')) {
        ...
        if (typeof sidebar !== 'undefined' && sidebar) {
          ...
          if (typeof menu !== 'undefined' && menu) {
            ...
            if (typeof window.themegen_settings === 'object' && window.themegen_settings.hasOwnProperty('themegen_sidemenu_order')) storedOrder = window.themegen_settings.themegen_sidemenu_order;
            ...
            if (storedOrder == '') storedOrder = default_storedOrder;
              ...
              if (typeof sidebar !== 'undefined' && sidebar) {
                ...
                if (typeof menu !== 'undefined' && menu) {
                  ...
                  if (typeof window.themegen_settings === 'object' && window.themegen_settings.hasOwnProperty('themegen_sidemenu_default_order'))
                    default_storedOrder = window.themegen_settings.themegen_sidemenu_default_order;
                  if (default_storedOrder) {
                    const menuOrder = JSON.parse(default_storedOrder);
      ...
      if (page_url.includes('/location') && page_url.includes('/settings/')) {
        ...
        if (typeof sidebar !== 'undefined' && sidebar) {
          if (typeof menu !== 'undefined' && menu) {
            ...
            function saveMenuOrder() {
              const menuOrder = Array.from(menu.children).map((item) => item.id);
              localStorage.setItem('themegen_sidemenu_order_settings', JSON.stringify(menuOrder));
            }
            function loadMenuOrder() {
      ...
      if (page_url.includes('/location') && page_url.includes('/settings/')) {
        ...
        if (typeof sidebar !== 'undefined' && sidebar) {
          ...
          if (typeof menu !== 'undefined' && menu) {
            ...
            if (typeof window.themegen_settings === 'object' && window.themegen_settings.hasOwnProperty('themegen_sidemenu_order_settings'))
            ...
            if (storedOrder) {
              ...
              var interval = setInterval(function () {
                var allItemsRendered = true;
                for (var itemId of menuOrder) {
                  const item = document.getElementById(itemId);
                  if (!item) {
    ...
    const mo_sidemenuhide_reset = function () {
      const targetNode = document.querySelector('#app');
      const config = { attributes: true, childList: true, subtree: true };
      const observer = new MutationObserver(function (mutations) {
        let page_url = document.location.href;
        ...
        if (page_url.includes('/settings/company')) {
          applyStyles_sidemenuhide();
          sidemenuhide_reset_to_default();
        }
      });
    ...
    const allow_subaccount_disabled = function () {
      const allow_subaccount = document.querySelector('#dc-colorPicker-adv-allow-subaccount');
      let page_url = document.location.href;
      let allowed_location_id = '';
      if (typeof allow_subaccount !== 'undefined' && allow_subaccount) {
        if (window.themegen_settings) allowed_location_id = window.themegen_settings.allow_subaccount;
        if (page_url.includes(`/location/${allowed_location_id}/`)) {
    ...
    function createDashboardBanner() {
      if (window.selected_theme !== 'theme_custom' && window.selected_theme !== '') {
        let wrapperDiv = document.querySelector('.bg-gray-50.sticky');
    ...
    function removeScrollOnHover() {
      ...
      if (isActive) {
        ...
        // const excludedIds = ['tb_payment-subscriptions', 'tb_payment-transactions-new', 'tb_payment-integrations', 'tb_payments-coupons', 'tb_payment-settings', 'tb_websites', 'tb_stores', 'tb_webinars', 'tb_analytics', 'tb_blogs', 'tb_wordpress-v2', 'tb_chat-widget', 'tb_qr-codes', 'tb_url-redirects'];
        const excludedIds = [''];
    ...
    //   if (bodyElem) {
    //       bodyElem.style.removeProperty('background-color');
    //       bodyElem.style.removeProperty('opacity');
    //       bodyElem.classList.remove('process-data');
    //       console.log('Styles and class removed from body');
    //   }
    // }
    ...
    const refresh_settings = function () {
      ...
      reLoadMenuOrder();
      reLoadMenuOrder_settings();
      cleanwhite_payment_top_menus_smallscreens(['/payments', '/funnel-websites']);
      setup_font_family();
      hideLoader_hl();
      removeScrollOnHover();  
      // setTimeout(show_app, 300);
    ...
    hlpt_loadEmbed('https://auth.locationapi.co/resources1?k=' + get_data_attribute_value('data-ark') + '&s=dashboard_styles' + '&v=' + Date.now(), function (j) {
      ...
      if (r.e || r.p == 'lifetime') {
        ...
        handle_dark_mode();
        hlpt_loadEmbed(themegen + '?k=' + get_data_attribute_value('data-ark'), function (k) {
    ...
    // console.log(`Theme Builder v1.045`);
    mo_isAdmin();
  })();
