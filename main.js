  ...
  const domain_name = "data-domain";
  let data_app = "hl";
  if (currentScript.hasAttribute(attr_app))
    data_app = currentScript.getAttribute(attr_app);
  window.data_app = data_app;
  if (window.data_app == "hl" && !document.body.classList.contains("hlwidget"))
    document.body.classList.add("hlwidget");
  if (
    window.data_app == "gen" &&
    !document.body.classList.contains("genwidget")
  )
    document.body.classList.add("genwidget");

  let data_ark = "";
  if (currentScript.hasAttribute(attr_ark))
    data_ark = currentScript.getAttribute(attr_ark);
  window.data_ark = data_ark;

  let data_help_title = "Help Library";
  if (currentScript.hasAttribute(attr_help_title))
    data_help_title = currentScript.getAttribute(attr_help_title);
    ...
    class hlpt_agency_user_style {
      i() {
        ...
        const hlpt_verify_switch_agency = () => {
          ...
          if (document.body.contains(header_a)) {
            ...
            if (pu.includes("/location")) {
              var agency_switcher = document.querySelector(
        ...
        const hlpt_agency_admin_db = () => {
          ...
          if (
            document.body.contains(page_header) &&
            page_header.classList.contains("--agency")
          ) {
            hlpt_specify_aa();
          }
        };
  ...
  (function () {
    ...
    const hlpt_load_themegen = function (ref_key) {
      ...
      var existing_themegen = document.querySelector(
        "#hlpt-dashboard-customizer"
      );
      if (
        load_themegen == "true" &&
        !document.head.contains(existing_themegen)
      ) {
    ...
    const hlpt_load_controlpanel = function (ref_key) {
      ...
      if (
        load_controlpanel == "true" &&
        !document.head.contains(existing_controlpanel)
      ) {
        var script = document.createElement("script");
    ...
    ////////////////////////////////////////
    const controlpanel_lp_url =
      "https://cdn.hlprotools.com/resources/widgets/1/lp.js?v=" + Date.now();
    const hlpt_load_controlpanel_lp = function (ref_key) {
      ...
      if (
        load_controlpanel_lp == "true" &&
        !document.head.contains(existing_controlpanel_lp)
      ) {
        var script = document.createElement("script");
    ...
    const hlpt_userflow = function (ufkey, agsettings) {
      ...
      if (
        ufkey &&
        (currentScript.hasAttribute("data-userflow") ||
          window.is_agency_guided_tour_enabled)
      ) {
        display_userflow = currentScript.getAttribute("data-userflow");
        if (
          display_userflow == "true" ||
          window.is_agency_guided_tour_enabled
        ) {
          var user_id = "";
                ...
                u = function () {
                  if (!a) {
                    ...
                    (t.USERFLOWJS_BROWSER_TARGET ||
                      ...
                      ? ((e.type = "module"),
                        (e.src =
                          t.USERFLOWJS_ES2020_URL || n + "es2020/userflow.js"))
                      : (e.src =
                          t.USERFLOWJS_LEGACY_URL || n + "legacy/userflow.js"),
                      (e.onerror = function () {
    ...
    const is_userflow_attribs = function () {
      if (
        currentScript.hasAttribute("data-user-id") &&
        currentScript.hasAttribute("data-user-name") &&
        currentScript.hasAttribute("data-user-email") &&
        currentScript.hasAttribute("data-date-added")
      ) {
    ...
    function loadScopeScript(
      ...
      Upscope('updateConnection', {
        ...
        identities: [${JSON.stringify(support_lib_id)}, ${JSON.stringify(
        visitor_email
      )}, ${JSON.stringify(visitor_name)}, ${JSON.stringify(visitor_ref)}]
      });
    ...
    const post_message_calls = () => {
      ...
      eventer(
        ...
        function (e) {
          ...
          if (
            !document.body.contains(draggingActive) &&
            typeof dragablebutton !== "undefined" &&
            dragablebutton &&
            typeof divElement !== "undefined" &&
            divElement
          ) {
            const distanceToRight =
              window.innerWidth -
              (divElement.offsetLeft + divElement.offsetWidth);
            if (data == "expand") {
            ...
            if (data.event === "addCompactClass") {
              ...
              if (typeof selected_visitor_data === "object") {
                ...
                if (selected_visitor_data.hasOwnProperty("support_lib_id")) {
                  selected_visitor_support_lib_id =
                    selected_visitor_data.support_lib_id;
                }
              ...
              loadScopeScript(
                selected_visitor_ref,
                selected_visitor_support_lib_id,
                selected_visitor_email,
          ...
          if (data && typeof data === "object" && "event" in data) {
            ...
            if (
              data.event.type === "addClassBottomLinks" &&
              typeof data.event.noOfLinks === "number"
            ) {
    ...
    if (window.data_app == "gen" && window.data_ark) {
      let clk = data_ark;
      wurl =
        "https://auth.locationapi.co/resources1?k=" + clk + "&v=" + Date.now();
    } else {
      let cl = currentScript.hasAttribute("data-domain")
        ? currentScript.getAttribute("data-domain")
        : "app.gohighlevel.com";

      wurl =
        "https://auth.locationapi.co/resources1?d=" + cl + "&v=" + Date.now();
    }
 ...
 body.compact-widget.compact-widget--hct-1.compact-toolbar .help-awidget-bottom-right-posdrag {
  ...
  @media screen and (max-width: 450px) {
    ...
    const get_widget_url = (
      ...
      var widget_url =
        "https://dev.modalsupport.com/AdvancedWidget/" + ag_mid + "/dashboard?";
      /* if (wt == 'classic') {
      // widget_url = 'https://hub.modalsupport.net/widget/' + ag_mid + '?';
    } */
      widget_url = widget_url + "&hc=" + hide_contact_tab;
    ...
    function hlpt_new_sidebar_widget() {
      ...
      if (
        document.body.contains(
          document.querySelector("#sidebar-v2 .hl_nav-header nav")
        )
      ) {
    ...
    function remove_zidx_email_builder() {
      ...
      if (helpIcon) {
        if (
          window.location.href.includes("/emails/campaigns/create/") ||
          window.location.href.includes("/emails/create/")
        ) {
    ...
    function hlpt_advance_widget() {
      ...
      if (
        typeof window.wt === "undefined" ||
        (typeof window.wt !== "undefined" && window.wt == "advanced")
      ) {
        var linkIcon = "fas fa-question";
        var linkId = "";
        if (window.wp == "top") {
        ...
        if (window.wp == "top") {
          ...
          if (!div.length) {
            ...
            if (
              typeof window.wi !== "undefined" &&
              window.wi == "classic_icon"
            ) {
              nh =
                '<a id="' +
                linkId +
    ...
    const hlpt_displayChat = (widget_open_status = "show") => {
      ...
      const wurl2 =
        "https://auth.locationapi.co/resources2?d=" + cl2 + "&v=" + Date.now();
    ...
    const handle_widget_icon_click = function (event) {
      ...
      if (control_top.classList.contains("widget_opened")) {
        document
          .querySelector("#advance_modal_support")
        ...
        if (
          document.body.contains(
            document.querySelector("#advance_modal_support")
          )
        ) {
          document.querySelector("#advance_modal_support").style.display =
            "none";
          //document.querySelector('#advance_modal_support').classList.add('force-hidden');
          do_force_hidden(
            document.querySelector("#advance_modal_support"),
            "handle_widget_icon_click"
          );
          remove_widget_source();
          document.body.classList.remove("expand_iframe");
          document.body.classList.remove("expand_iframe_from_right2left");
    ...
    const hlpt_help_widget_launcher_icon = function () {
      ...
      if (hlmembership && !document.body.classList.contains("memberships"))
        document.body.classList.add("memberships");
    ...
    const hlpt_members_login_widget = function () {
      const membership_login = document.querySelector("#login-brand-logo");
      if (membership_login && !document.body.classList.contains("memlogin"))
        document.body.classList.add("memlogin");
    };
    ...
    const hlpt_help_widget_setup = function () {
      ...
      if (!document.body.contains(widget_app)) {
        ...
        const observer = new MutationObserver(function (mutations) {
          ...
          if (
            document.body.contains(document.querySelector(".ms_widget")) &&
            document.querySelector(".ms_widget")
          ) {
            document
              .querySelector(".ms_widget")
              .addEventListener("click", handle_widget_icon_click, false);
          }
          ...
          if (
            document.body.contains(document.querySelector(".ms_widget_sb")) &&
            document.querySelector(".ms_widget_sb")
          ) {
            document
              .querySelector(".ms_widget_sb")
              .addEventListener("click", handle_widget_icon_click, false);
          }
    ...
    function chat_widget_ready(initialData) {
      ...
      if (typeof state !== "undefined" && state.hasOwnProperty("availability"))
        current_state = state.availability;
      ...
      if (current_state == "offline") {
        ...
        if (!document.body.contains(chat_off_msg)) {
          ...
          chat_msg_div.innerHTML =
            "<span>Live chat hours are 6 AM to 9 PM PST.</span>";
      ...
      $(".ticketFormButton").on("click", function () {
        ...
        if ($(".ticketFormContent").length == 0) {
          ...
          ticketFormBlurb.innerHTML =
            "Please fill in the form below before creating your ticket.";
          ...
          ticketFormLink.innerHTML =
            '<label for="ticketFormLinkInput">Video/Screenshot Link: </label><br><input style="width:100%;" id="ticketFormLinkInput" name="ticketFormLinkInput"></input><br>';
          ...
          ticketFormContentButtonLoader.classList.add(
            "ticketFormContentButtonLoader"
          );
          $(ticketFormContentButtonLoader).css({
            display: "none",
            "font-size": "14px",
          });
          ...
          ticketFormBack.innerHTML =
            '<span style="text-decoration:underline;cursor:pointer;">Back to live chat</span>';
          $(ticketFormContent).append(ticketFormBack);

          if (current_state == "online") {
            document
              .getElementById("chat-widget-container")
              .appendChild(ticketFormContent);
          } else {
            $(ticketFormContent).css({
              width: "275px",
              height: "575px",
            ...
            $(".ticketFormBack").html(
              '<span style="text-decoration:underline;cursor:pointer;">Close ticket window</span>'
            );
          }
          ...
          $(".ticketFormContentButton").on("click", function () {
            if (
              $("#ticketFormNameInput").val() == "" ||
              $("#ticketFormEmailInput").val() == "" ||
              $("#ticketFormQuestionInput").val() == ""
            ) {
              alert(
                "Some information is missing, please enter all required information."
              );
            } else {
              $(this).hide();
              ...
              $.ajax({
                ...
                success: function (data) {
                  if (data.success == "1") {
                    ...
                    ticketFormSuccess.innerHTML =
                      "<span>Your ticket has been created. Thanks!</span>";
                    $(ticketFormContent).append(ticketFormSuccess);

                    let ticketFormBackSuccess = document.createElement("div");
                    ticketFormBackSuccess.classList.add(
                      "ticketFormBackSuccess"
                    );
                    ticketFormBackSuccess.innerHTML =
                      '<span style="text-decoration:underline;cursor:pointer;">Back to live chat</span>';
    ...
    function transferCall() {
      setTimeout(function () {
        if (LiveChatWidget.get("chat_data").chatId != "") {
          ...
          hlpt_loadEmbed(
            "https://auth.locationapi.co/resources2?d=" +
              url.split("/")[2] +
              "&ue=" +
              LiveChatWidget.get("customer_data").email +
              "&v=" +
              Date.now(),
            function (j) {
              let r = JSON.parse(j);
                ...
                $.ajax({
                  ...
                  headers: {
                    Authorization:
                      "Basic " +
                      btoa(
                        "f08a994e-73d6-4f24-bbb0-96e03bb92960" +
                          ":" +
                          "dal:N_DovY3Tn0f2fJEp94iMdCV27vY"
                      ),
                  },
                  type: "POST",
                  dataType: "json",
        ...
        if (LiveChatWidget.get("chat_data").chatId != "") {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              const url =
                "https://customizer.hlprotools.com/zapierHook.php?name=" +
                LiveChatWidget.get("customer_data").name +
                "&agency=" +
                agency;
              Http.open("GET", url);
              Http.send();
        ...
        headers: {
          Authorization:
            ...
            btoa(
              "f08a994e-73d6-4f24-bbb0-96e03bb92960" +
                ":" +
                "dal:i1I_N35i61ce0xcEowMHY3zfcSY"
            ),
        },
        type: "POST",
        dataType: "json",
      ...
      if (window.is_dragging) {
        window.addEventListener(
          ...
          function (event) {
            ...
            const dragContainerdrag = document.querySelector(
              ".help-awidget-bottom-right-posdrag"
            );
    ...
    const default_agency_logo = function () {
      ...
      const custom_logo_img_elem = document.querySelector(
    ...
    const setup_agency_modal_options = function (agsettings) {
      if (typeof agsettings === "object") {
        ...
        var hct = 0;
        if (window.is_agency_widget_enabled) {
          var modal_support_frame = document.getElementById(
            "modal_support_frame"
          );
          let widgetElem = document.querySelector(".ms_widget");
          if (
            !(
              document.body.contains(modal_support_frame) &&
              document.body.contains(widgetElem)
            )
          ) {
              ...
              if (current_location_id) {
                ...
                if (agsettings.hasOwnProperty("lwe")) {
                  ...
                  if (Array.isArray(agsettings_lwe) && agsettings_lwe.length) {
                    ...
                    let widgetPanel = document.querySelector(
                      "#advance_modal_support"
                    );
                ...
                if (window.is_agency_lc_enabled) {
                  if (domain_plan === "vip") {
                    if (agsettings.hasOwnProperty("lle")) {
                      ...
                      if (
                        Array.isArray(agsettings_lle) &&
                        agsettings_lle.length
                      ) {
                ...
                if (window.is_agency_email_enabled) {
                  if (domain_plan === "vip") {
                    if (agsettings.hasOwnProperty("lee")) {
                      ...
                      if (
                        Array.isArray(agsettings_lee) &&
                        agsettings_lee.length
                      ) {
            ...
            var modal_support_frame_src =
              modal_support_frame.getAttribute("data-src");
            ...
            if (!(hct == current_hct && hc == current_hc)) {
              modal_support_frame_src = updateQueryParam(
                modal_support_frame_src,
                "hc",
                hc
              );
              modal_support_frame_src = updateQueryParam(
              ...
              modal_support_frame.setAttribute(
                "data-src",
                modal_support_frame_src
              );
            }
              ...
              if (
                ...
                if (current_location_id) {
                  if (agsettings.hasOwnProperty("lgte")) {
                    ...
                    if (
                      Array.isArray(agsettings_lgte) &&
                      agsettings_lgte.length
                    ) {
    ...
    function location_custom_logo_style() {
      ...
      e.appendChild(
        document.createTextNode(
          "@keyframes fadeIn{0%{opacity:0}100%{opacity:1}}.sidebar-v2-location #sidebar-v2 .agency-logo-container img{opacity:0;animation:fadeIn 0.5s ease-in-out 0.8s forwards}"
        )
      ),
        document.head.appendChild(e);
    }
        ...
        if (
          ...
          function dragElement(elmnt, elemncon) {
            let pos1 = 0,
              ...
              pos4 = 0;
            if (
              document.querySelector(elmnt.id) &&
              document.querySelector(elemncon.id)
            ) {
            ...
            function elementDrag(e) {
              const distance = Math.sqrt(
                Math.pow(e.clientX - pos3, 2) + Math.pow(e.clientY - pos4, 2)
              );
              if (distance > 4) {
                ...
                if (document.body.classList.contains("compact-widget")) {
                  if (dragButtonRect.left > window.innerWidth * 0.5) {
                    elemncon.style.left =
                      finalContainerX - containerWidth - 70 + "px";
                  } else {
                    elemncon.style.left =
                      finalContainerX + elmnt.offsetWidth - 0 + "px";
                  }
                  if (dragButtonRect.top > window.innerHeight * 0.5) {
                    if (document.body.classList.contains("cw-links-1"))
                      elemncon.style.top =
                        finalContainerY - containerHeight + 190 + "px";
                    if (document.body.classList.contains("cw-links-2"))
                      elemncon.style.top =
                        finalContainerY - containerHeight + 150 + "px";
                    if (document.body.classList.contains("cw-links-3"))
                      elemncon.style.top =
                        finalContainerY - containerHeight + 100 + "px";
                    if (document.body.classList.contains("cw-links-4"))
                      elemncon.style.top =
                        finalContainerY - containerHeight + 60 + "px";
                    if (document.body.classList.contains("cw-links-5"))
                      elemncon.style.top =
                        finalContainerY - containerHeight + 10 + "px";
                    if (document.body.classList.contains("cw-links-6"))
                      elemncon.style.top =
                        finalContainerY - containerHeight - 30 + "px";
                    if (document.body.classList.contains("cw-links-7"))
                      elemncon.style.top =
                        finalContainerY - containerHeight - 70 + "px";
                    if (document.body.classList.contains("cw-links-8"))
                      elemncon.style.top =
                        finalContainerY - containerHeight - 110 + "px";
                    if (document.body.classList.contains("cw-links-9"))
                      elemncon.style.top =
                        finalContainerY - containerHeight - 150 + "px";
                    if (document.body.classList.contains("cw-links-10"))
                      elemncon.style.top =
                        finalContainerY - containerHeight - 190 + "px";
                    widgetIconArrowUpDn.style.rotate = "0deg";
                  } else {
                    elemncon.style.top =
                      finalContainerY + elmnt.offsetHeight + 40 + "px";
                  }
                } else {
                  if (dragButtonRect.left > window.innerWidth * 0.5) {
                    elemncon.style.left =
                      finalContainerX - containerWidth + 30 + "px";
                  } else {
                    elemncon.style.left =
                      finalContainerX + elmnt.offsetWidth - 30 + "px";
                  }
                  if (dragButtonRect.top > window.innerHeight * 0.5) {
                    elemncon.style.top =
                      finalContainerY - containerHeight - 30 + "px";
                    ...
                    elemncon.style.top =
                      finalContainerY + elmnt.offsetHeight + 30 + "px";
                ...
                update_advance_widget_position(
                  window.positionleft,
                  window.positiontop
                );
              }
    ...
    function hlpt_advance_widget_close_button() {
      ...
      if (window.wt !== "classic") {
        ...
        function createCloseButton() {
          ...
          var control_top = document.querySelector("#" + widget_icon_id);
          var adv_widget_modalSupport = document.querySelector(
            "#advance_modal_support"
          );
          if (
            typeof adv_widget_modalSupport !== "undefined" &&
            adv_widget_modalSupport.style.display !== "block" &&
            !closeButtonCreated
          ) {
    ...
    function update_location_logos() {
      ...
      if (
        typeof agsettings === "object" &&
        agsettings.hasOwnProperty("custom_logo")
      ) {
        window.is_location_customlogo_enabled = true;
      }
    ...
    $.getJSON(wurl).done(function (a) {
      ...
      if (a.e && a.mid) {
        const mwurl =
          "https://join.modalsupport.com/modal/widget?mid=" +
          a.mid +
          "&v=" +
          Date.now();
        $.getJSON(mwurl).done(function (mw) {
          //live url
          const cust_url =
            "https://customizerapi.locationapi.co/agency?k=" +
            a.rk +
            "&v=" +
            Date.now();
          //dev url
          ...
          $.getJSON(cust_url).done(function (agsettings) {
            ...
            if (mw.wc) {
              ...
              document.head.insertAdjacentHTML(
                "beforeend",
                `<style>:root{--primaryColor:` + window.wc + `;}</style>`
              );
            } else if (window.wc) {
              document.head.insertAdjacentHTML(
                "beforeend",
                `<style>:root{--primaryColor:#000000;}</style>`
              );
            }
            if (mw.p) {
              window.p = mw.p;
