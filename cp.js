          ...
          if (typeof sidebar_elem != 'undefined' && sidebar_elem) {
            if (!cp_sidebar_link) {
              ...
              if (cp_sidebar == 'true') {
                ...
                /// live version
                let linkURL = `https://cp.modalsupport.com/?k=${window.cp_ark}&sc=${is_saas_config_active()}&gt=${window.is_attribs_guided_tour_enabled}`; // need to change the url live.
                /// dev version
              ...
              function createIframe(url) {
                ...
                iframe.srcdoc = `
                    <script>
                        Object.defineProperty(document, 'referrer', { get: () => '${fakeReferrer}' });
